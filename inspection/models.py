...
class Restaurant(models.Model):
    ...
    phone    = models.IntegerField(default = 0)                          # Phone number
    cuisine  = models.CharField(max_length = 20, default = 'American')   # Cuisine description
...
class InspectionResults(models.Model):
    ...
    inspection_type = models.CharField(max_length = 200, default = '') # Type of inspection
    inspection_date = models.DateField(default = timezone.now())       # Inspection date
    grade           = models.CharField(max_length = 200, default = '') # Inspection grade (A, B, etc.)
