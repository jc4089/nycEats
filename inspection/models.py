...
class Restaurant(models.Model):
    ...
    name     = models.CharField(max_length = 100, default = 'Restaurant') # Restaurant name
    boro     = models.CharField(max_length = 100, default = 'Manhattan')  # Borough
    building = models.CharField(max_length = 100, default = '0')          # Building number (can contain hypen)
    street   = models.CharField(max_length = 100, default = 'Main St')    # Street name
...
class InspectionResults(models.Model):
    ...
    grade           = models.CharField(max_length = 100, default = '') # Inspection grade (A, B, etc.)
